    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_background', models.ImageField(blank=True, null=True, upload_to='profile_backgrounds/', verbose_name='프로필 배경')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blocked_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blocked_by', to=settings.AUTH_USER_MODEL, verbose_name='차단된 사용자')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blocked_users', to=settings.AUTH_USER_MODEL, verbose_name='사용자')),
            ],
            options={
                'verbose_name': '차단된 사용자',
                'verbose_name_plural': '차단된 사용자',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tag', models.CharField(max_length=50, verbose_name='관심 태그')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='생성일')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interests', to=settings.AUTH_USER_MODEL, verbose_name='사용자')),
            ],
            options={
